...
module.exports = {
    ...
    (footprint "ceoloide:battery_connector_jst_ph_2"
        ...
        `
        const front_pads = `
        (pad "1" smd roundrect (at -1 0 ${p.r}) (size 1.2 1.75) (drill 0.75) (layers "F.Cu" "F.Mask") (roundrect_rratio 0.20) ${p.BAT_N.str})
        (pad "2" smd oval (at 1 0 ${p.r}) (size 1.2 1.75) (drill 0.75) (layers "F.Cu" "F.Mask") ${p.BAT_P.str})
        `
        const back_pads = `
        (pad "1" smd roundrect (at 1 0 ${p.r}) (size 1.2 1.75) (drill 0.75) (layers "B.Cu" "B.Mask") (roundrect_rratio 0.20) ${p.BAT_N.str})
        (pad "2" smd oval (at -1 0 ${p.r}) (size 1.2 1.75) (drill 0.75) (layers "B.Cu" "B.Mask") ${p.BAT_P.str})
        `
